            ...
            <Row> 
              ...
              <div >
                ...
                <ul style={{paddingLeft: '30px'}}>
                  <li style={{color: '#1d1d1d', fontFamily: 'Courier New, Courier, monospace', fontWeight: '500', listStyleType: 'unset', fontSize: '16px', marginBottom: '20px'}}>When you visit our Site LINK (next - the Site), place an order on it, follow our news and updates, We ask you to provide us with your personal data, in particular, your name, surname, father's name, e-mail address, phone number and delivery address.</li>
