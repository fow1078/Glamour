              ...
              <form style={{marginBottom: '30px'}}>
                ...
                <div>
                  ...
                  <FloatingLabel controlId="floatingInput" label="Address / Post Office" className="mb-3" >
                    <Form.Control type="text" value={address} onChange={handleAddressChange} placeholder="name@example.com" />
                  </FloatingLabel>

                  <FloatingLabel controlId="floatingInput" label="Address Details (Optional)" className="mb-3" >
                    <Form.Control type="email" value={addressDetails} onChange={handleAddressDetailsChange} placeholder="name@example.com" />
                  </FloatingLabel>
                  ...
                  <FloatingLabel controlId="floatingInput" label="Phone Number" className="mb-3" >
                    <Form.Control type="tel" value={number} onChange={handleNumberChange} placeholder="name@example.com" />
                  </FloatingLabel>

                  <div style={{width: '100%', textAlign: 'center'}}>
                    {/* Link to Thank you */}
                    <button onClick={handleSubmit} className='addtocart-btn'>Checkout</button> 
                  </div>
        ...
        <Col xs={12} lg={5} xl={6} style={{minHeight: '100%'}}>
          <div style={{padding: '40px 30px', backgroundColor: 'rgb(241 241 241)', borderLeft: '1px solid rgb(181 181 181)', height: '100%'}}>
            {cartItems.map((item, ind) => {
              return <article key='ind' className='cart-item'>
